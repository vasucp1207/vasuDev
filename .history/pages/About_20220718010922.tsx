  ...
  return (
    <div className='mt-10 h-screen relative'>
        <div className='flex flex-col justify-center items-center'>
            <h1 className='text-7xl z-10'>About Me</h1>
            <p className='text-4xl mt-8 z-10'>Hello👋, my name is Vasu Singh</p>
            <p className='text-xl mt-5 z-10'>I'm am an undergrad student interested in Machine Learining, Web Developmet </p>
            <p className='text-xl mt-5 z-10'>and Comptetive Programming. Currently I'm mainly working on OpenSource also play with </p>
            <p className='text-xl mt-5 z-10'>Neural Networks on weekends.</p>
            <h3 className='text-2xl mt-5 z-10'>Skills</h3>
