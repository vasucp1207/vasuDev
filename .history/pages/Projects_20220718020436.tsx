...
function Projects() {
    return (
        <div className='flex flex-col gap-4 justify-center items-center mt-20 h-screen'>
            <h1 className='text-7xl mb-20 z-10'>Projects</h1>
            <div className='md:flex md:flex-row flex flex-col gap-10 z-10'>
                <Cards
            ...
            <img src='Background.png' className='absolute z-0 overflow-hidden' />
        </div>
    )
}
