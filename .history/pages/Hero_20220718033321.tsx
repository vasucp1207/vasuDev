...
function Hero() {
  return (
    <div className='home h-screen bg-darkB relative'>
        <div className='mt-text-white flex flex-col justify-center items-center h-screen'>
            ...
            <button className='z-30 hover:text-white transition-all 200 bg-transparent mt-20 
        ...
        <img src='bottom.png' className='absolute z-0 right-0 -top-10' />
