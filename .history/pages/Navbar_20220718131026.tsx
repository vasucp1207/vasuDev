...
function Navbar() {
  ...
  return (
    <div>
      ...
      <Link to='home' smooth={true} duration={500} ><p className='absolute mt-30 hover:bg-fuchsia-500 cursor-pointer h-20 flex items-center justify-center'>Home</p></Link>
    </div>
  )
}
