  ...
  return (
    <div className='h-screen bg-darkB'>
        <div className='text-white flex flex-col justify-center items-center h-screen'>
            ...
            <button className='z-10 hover:text-white transition-all 200 hover:bg-green-400 mt-10 bg-white text-black h-10 w-40 outline-none rounded-full text-xl'>Contact Me</button>
        </div>

        <img src='top.png' className='absolute -top-4 -left-4 z-0' />
        <img src='bottom.png' className='absolute z-0 left-0 top-0' />
    </div>
  )
}
