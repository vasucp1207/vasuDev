  ...
  return (
    <div className='h-screen bg-darkB relative'>
        <div className='text-white flex flex-col justify-center items-center h-screen'>
            ...
            <button className='z-10 hover:text-white transition-all 200 bg-transparent mt-10 hover:bg-gradient-to-r from-violet-500 to-fuchsia-500 h-10 w-40 outline-none rounded-full text-xl'>Contact Me</button>
        </div>
