  ...
  return (
    <div className='h-screen bg-darkB relative'>
        <div className='text-white flex flex-col justify-center items-center h-screen'>
            ...
            <button className='z-10 hover:text-white transition-all 200 bg-trans mt-10 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-black h-10 w-40 outline-none rounded-full text-xl'>Contact Me</button>
        </div>
