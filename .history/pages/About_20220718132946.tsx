  ...
  return (
    <div className='h-screen relative about'>
        <div className='flex flex-col justify-center items-center'>
            ...
            <p className='md:text-xl mt-5 z-20 text-xl md:inline hidden'>I'm am an undergrad student interested in Machine Learining, Web Developmet </p>
            <p className='md:text-xl z-20 text-xl md:inline hidden'>and Comptetive Programming. Currently I'm mainly working on OpenSource also play with </p>
            <p className='md:text-xl z-20 text-xl md:inline hidden'>Neural Networks on weekends.</p>
            <p className='text-xl z-20 flex justify-center items-center lg:hidden'>I'm am an undergrad student interested in Machine Learining, Web Developmet and Comptetive Programming. Currently I'm mainly working on OpenSource also play with Neural Networks on weekends.</p>
            <h3 className='s:text-5xl mt-5 z-10 text-2xl'>Skills</h3>
