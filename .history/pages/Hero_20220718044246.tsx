  ...
  return (
    <div className='home h-screen bg-darkB relative'>
        <div className='mt-10 text-white flex flex-col justify-center items-center h-screen'>
            ...
            <button className='mt-10 z-30 hover:outline-none transition-all duration-300 bg-transparent
            hover:bg-gradient-to-r from-violet-500 to-fuchsia-500 h-12 w-40 
        ...
        <img src='bottom.png' className='absolute z-0 right-0 top-10 animate-pulse' />
