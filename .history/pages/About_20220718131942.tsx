  ...
  return (
    <div className='h-screen relative about'>
        <div className='flex flex-col justify-center items-center'>
            <h1 className='md:text-7xl z-20 mt-10 text-4xl'>About Me</h1>
            ...
            <p className='md:text-xl z-20'>and Comptetive Programming. Currently I'm mainly working on OpenSource also play with </p>
            <p className='md:text-xl z-20'>Neural Networks on weekends.</p>
            <h3 className='md:text-5xl mt-5 z-10 text-xl'>Skills</h3>
