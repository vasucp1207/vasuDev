  ...
  return (
    <div className='bg-darkB'>
        <div>
            ...
            <p className='text-xl w-160 mt-5'>I'm am an undergrad student interested in Machine Learining, Web Developmet and Comptetive Programming. Currently I'm mainly working on OpenSource also play with Neural Networks on weekends.</p>
