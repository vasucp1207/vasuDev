  ...
  return (
    <div className='mt-10 h-screen relative'>
        <div className='flex flex-col justify-center items-center'>
            ...
            <p className='text-xl mt-5 z-10'>I'm am an undergrad student interested in Machine Learining, Web Developmet and Comptetive Programming. Currently I'm mainly working on OpenSource also play with Neural Networks on weekends.</p>
