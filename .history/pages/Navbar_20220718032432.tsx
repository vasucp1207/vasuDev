  ...
  return (
    <div>
      {!active && <div className='z-10 h-20 w-screen fixed z-40 bg-transparent flex justify-center items-center'>
        <div className='flex gap-10 text-xl font-normal mr-5 items-center justify-center'>
          <Link to='home' smooth={true} duration={500} ><p className='hover:bg-fuchsia-500 cursor-pointer h-20 flex items-center justify-center block'>Home</p></Link>
